...
CSV format. One file is reported per line of output.  Output can seem to be 
random since the program is treaded but every file does get reported. 
...
Stuff you need for building pwalk: GNU gcc and glib,pthread development 
libraries. [This section needs more informaiton]
